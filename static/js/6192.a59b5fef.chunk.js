"use strict";(self.webpackChunksmart_mining=self.webpackChunksmart_mining||[]).push([[6192],{6192:(e,t,i)=>{i.r(t),i.d(t,{AppKitModal:()=>ye,W3mModal:()=>ge,W3mModalBase:()=>ve});var o=i(7022),a=i(8117),r=i(6440),s=i(3264),n=i(2661),c=i(6132),l=i(7321),w=i(5015),d=i(6496),p=i(1139),u=i(7994);const m={isUnsupportedChainView:()=>"UnsupportedChain"===p.I.state.view||"SwitchNetwork"===p.I.state.view&&p.I.state.history.includes("UnsupportedChain"),async safeClose(){if(this.isUnsupportedChainView())return void c.W.shake();await u.U.isSIWXCloseDisabled()?c.W.shake():c.W.close()}};var h=i(6141),v=i(7258),g=i(7038),y=i(282),f=i(9446),b=i(7845);const k=o.AH`
  :host {
    display: block;
...
`;var j=function(e,t,i,o){var a,r=arguments.length,s=r<3?t:null===o?o=Object.getOwnPropertyDescriptor(t,i):o;if("object"===typeof Reflect&&"function"===typeof Reflect.decorate)s=Reflect.decorate(e,t,i,o);else for(var n=e.length-1;n>=0;n--)(a=e[n])&&(s=(r<3?a(s):r>3?a(t,i,s):a(t,i))||s);return r>3&&s&&Object.defineProperty(t,i,s),s};let H=class extends o.WF{constructor(){super(...arguments),this.size="md",this.disabled=!1,this.icon="copy",this.iconColor="inherit"}render(){const e="lg"===this.size?"--wui-border-radius-xs":"--wui-border-radius-xxs",t="lg"===this.size?"--wui-spacing-1xs":"--wui-spacing-2xs";return this.style.cssText=`\n    --local-border-radius: var(${e});\n    --local-padding: var(${t});\n`,o.qy`
    ...
    `}};H.styles=[f.W5,f.fD,f.ck,D],j([(0,a.MZ)()],H.prototype,"size",void 0),j([(0,a.MZ)({type:Boolean})],H.prototype,"disabled",void 0),j([(0,a.MZ)()],H.prototype,"icon",void 0),j([(0,a.MZ)()],H.prototype,"iconColor",void 0),H=j([(0,b.E)("wui-icon-link")],H);i(1056),i(702);const M=o.AH`
  button {
    display: block;
    display: flex;
    align-items: center;
...
//# sourceMappingURL=6192.a59b5fef.chunk.js.map